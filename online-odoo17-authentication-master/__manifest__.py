{
    'name': "Online Odoo Authentication Master",
    'version': '1.0',
    ...
    'data': [
        ...
        'views/attendance_sync_views.xml',  # Move this above menu_views.xml
        'views/menu_views.xml',
        'views/company_credentials_views.xml',  # Keep it after attendance_sync_views.xml
