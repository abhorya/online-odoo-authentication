        ...
        for record in attendance_records:
            ...
            try:
                ...
                if existing_attendance:
                    ...
                    # Include biometric_device_id if it exists remotely
                    if 'biometric_device_id' in existing_field_names:
                        attendance_data['biometric_device_id'] = employee.biometric_device_id or ''
